...
@load "enc_example.jld2"

lambda = collect(0.0:10.0:200.0)
...
v = LibTest.testBandwidths2d( ex, 8, lambda )
...
for eps in 0.001:0.001:0.01
    ...
    f_eps = ANOVAapprox.approx( ex.X_train, ex.y_train, activeSet, v[1] )
