...
set ytics  10 logscale
set yrange [1e-15:5e-12]
set output "img/s5_rates_l2error.tex"
plot "plotdata/s5_rates_l2error.csv" using 1:2 with linespoints ls 1

set format y '\scriptsize $%.0l\cdot 10^{%L}$'
set ytics  1e-5 nologscale
set yrange [5e-6:1e-4]
set output "img/s10_rates_l2error.tex"
plot "plotdata/s10_rates_l2error.csv" using 1:2 with linespoints ls 1
