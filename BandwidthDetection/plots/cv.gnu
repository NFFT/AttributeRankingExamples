...
sigma = "`cat plotdata/s5_cv_sigma.csv`"
plot "plotdata/s5_cv_it1.csv" using "B":"cv" with linespoints ls 1 lc "#ffa500" title 'CV',\
    "plotdata/s5_cv_it1.csv" using "B":(column("L2error")**2+sigma**2) with points ls 1 pt 2 title '$(L_2$-error$)^2+\sigma^2$',\
    "plotdata/s5_cv_it2.csv" using "B":"cv" with linespoints ls 1 lc "#ff4dff" title 'CV',\
    "plotdata/s5_cv_it2.csv" using "B":(column("L2error")**2+sigma**2) with points ls 1 pt 2 title '$(L_2$-error$)^2+\sigma^2$',\
    "plotdata/s5_cv_it3.csv" using "B":"cv" with linespoints ls 1 lc "#00b3b3" title 'CV',\
    "plotdata/s5_cv_it3.csv" using "B":(column("L2error")**2+sigma**2) with points ls 1 pt 2 title '$(L_2$-error$)^2+\sigma^2$'
